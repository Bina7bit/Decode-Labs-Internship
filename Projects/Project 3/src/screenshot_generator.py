...
def generate_screenshots():
    ...
    terminal_logs = (
        "PS C:\\Users\\bina\\DecodeLabs-Internship\\Projects\\Project 3> python src/main.py\n"
        ...
        "PS C:\\Users\\bina\\DecodeLabs-Internship\\Projects\\Project 3>"
    )
    ...
    ax.text(0.05, 0.83, "Bina7bit / DecodeLabs-Internship", color="#58A6FF", fontsize=14, fontweight="bold", transform=ax.transAxes, zorder=2)
